...
K8S_API_FORBIDDEN_CODE = 403
RETRYABLE_HTTP_ERROR_CODES = (401, 403, 404, 408, 425, 429, 500, 501, 502, 503, 504)
...
def get_node_uid(node_name: str) -> str:
    ...
    try:
        ...
        if exc.status == K8S_API_FORBIDDEN_CODE:
            logger.error("Permission denied to get node UID.")
            return None
        raise
